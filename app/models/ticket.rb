class Ticket < ActiveRecord::Base
  ...
  def opened_at_local
    datetime_to_local(opened_at, link_time_zone) + ' ' + link_time_zone
  end

  def created_at_local
    datetime_to_local(created_at, link_time_zone) + ' ' + link_time_zone
  end
  ...
  def link_time_zone
    link.time_zone.nil? ? 'America/Mexico_City' : link.time_zone.name
  end
